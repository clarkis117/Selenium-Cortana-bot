...
namespace Selenium.Bot.App.ViewModels
{
	public struct BotVoiceCommand
	{
		...
		public BotVoiceCommand(string voiceCommand, string commandMode, string textSpoken, string destination)
		{
